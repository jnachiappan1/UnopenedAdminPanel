...
const schema = yup.object({
  password: yup.string().min(8, 'Password must be at least 8 characters').required('Enter Password'),
  ...
  return (
    <form onSubmit={handleSubmit(handleSetOtp)}>
      ...
      <FormControl fullWidth sx={{ mt: 1 }}>
        ...
        />
        <small style={{ color: '#FF0000', marginRight: 'auto' }}>{errors.password?.message}</small>
      </FormControl>
